...
class SurahPage2 extends StatefulWidget {
  final String id;
  final String surah;

  const SurahPage2(this.id, this.surah, {Key? key}) : super(key: key);

  @override
  _SurahPage2State createState() => _SurahPage2State();
}

class _SurahPage2State extends State<SurahPage2> {
  bool onhover = false;
