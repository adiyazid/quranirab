...
class MoreOptionsList2 extends StatefulWidget {
  final String surah;
  ...
  @override
  State<MoreOptionsList2> createState() => _MoreOptionsList2State();
}

class _MoreOptionsList2State extends State<MoreOptionsList2> {
  @override
