      ...
      body: SingleChildScrollView(
        child: Column(
            ...
            children: <Widget>[
              ...
              CircleAvatar( backgroundImage: AssetImage(themeProvider.isDarkMode?"images/dark.jpg":"images/light.jpg"),
                radius: 80,child: Stack(
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:themeProvider.isDarkMode?Color(0xff67748E): Color.fromRGBO(255, 181, 94, 1),
                  ),
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
          ...
          color: theme.isDarkMode
              ...
              : Color.fromRGBO(255, 255, 255, 1),
          border: Border.all(
            color:theme.isDarkMode?Color(0xff67748E): Color.fromRGBO(255, 181, 94, 1),
            width: 1,
          ),
        ),
        child: Center(
