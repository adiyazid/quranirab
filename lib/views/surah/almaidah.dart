...
class AlMaidah extends StatefulWidget {
  AlMaidah({Key? key}) : super(key: key);

  @override
  _AlMaidahState createState() => _AlMaidahState();
}

class _AlMaidahState extends State<AlMaidah> {
