  ...
  getStart(int? id, int? currentPage) async {
    ...
    var jsonData = {
      "split_sura": [
        ...
        {"page": 434, "sura_id": 34, "start": 0, "end": 7, "numStart": 3},
...
//waiting remaining sura
        ...
        if (!wordDetail
          ...
          labelCategory.add(WordDetail(
              isparent: doc["ancestry"].split("/").length == 1 ||
                  ...
                  : false,
              hasChild:
                  doc["ancestry"].split("/").length > 1 || doc["ancestry"] == ''
                      ? true
                      : false,
              childType: doc["child_type"],
              ancestry: doc["ancestry"] ?? '',
  ...
  Future<List<WordDetail>> getChild(
      int childID, String parentID, String langID) async {
    String temp = '';
    if (parentID == '') {
      temp = '$childID';
    } else {
