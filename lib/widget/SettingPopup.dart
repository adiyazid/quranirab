...
class _SettingPopupState extends State<SettingPopup> with TickerProviderStateMixin{
                       ...
                       ListView(
                          ...
                          children: <Widget>[
                            ...
                            Stack(
                              children: <Widget>[
                                Padding(
                                  padding: const EdgeInsets.fromLTRB(35, 16, 0, 15),
                                  child: Text(
                                    'Setting',
                                    style: TextStyle(
                            ...
                            Center(
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.fromLTRB(0, 10, 380, 16),
                                      child: Text('Theme',
                                          style: TextStyle(
                                            color: Theme.of(context).textSelectionColor,fontSize: 16,
                                          )),
